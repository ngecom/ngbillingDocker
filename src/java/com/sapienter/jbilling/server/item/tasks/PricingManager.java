...
public class PricingManager {
    ...
    public void setByPercentage(double percentage) {
        this.price = price.add(price.divide(new BigDecimal(100), ClientConstants.BIGDECIMAL_SCALE,
                ClientConstants.BIGDECIMAL_ROUND).multiply(new BigDecimal(percentage)));
    }
