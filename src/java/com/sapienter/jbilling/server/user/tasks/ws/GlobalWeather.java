    ...
    extends Service
{
    ...
    private final static FormatLogger logger = new FormatLogger(com.sapienter.jbilling.server.user.tasks.ws.GlobalWeather.class);
    ...
    static {
        ...
        try {
            ...
            logger.warn("Failed to create URL for the wsdl Location: 'http://www.webservicex.net/globalweather.asmx?WSDL', retrying as a local file");
